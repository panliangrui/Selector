    ...
    for seed in range(start_seed, start_seed + repeat_num):
        ...
        for train_index, test_index in kf.split(patients, kf_label):
            ...
            for epoch in range(epochs):
                ...
                all_loss, t_train_ci, t_train_ci_img, t_train_ci_rna, t_train_ci_cli = train_a_epoch(model, train_data, all_data,
                                                                                                     patient_and_time,
                                                                                                     patient_sur_type,
                                                                                                     batch_size,
                                                                                                     optimizer, epoch,
...
def get_params():
    ...
    parser.add_argument("--epochs", type=int, default=10, help="Cycle times of model training")

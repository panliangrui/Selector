...
def run(args):
    ...
    all_slide_name = joblib.load('../HGCN/UCEC/ucec_patients.pkl')

    new_silde_path_lists = []
    for path in slide_filepath_list:
        filename = os.path.basename(path)
        value = "-".join(filename.split("-")[:4])
...
def main():
    ...
    parser.add_argument('--slide_dir', type=str, default='J:\\LUAD_WSI\\luad_wsi')
    parser.add_argument('--save_dir', type=str, default='../Features/luad_256_features')

...
class PreModel(nn.Module):
    def __init__(
        ...
        # encoder
        self.encoder = setup_module(m_type ='han', in_channels=1024, out_channels=1024, num_layers=1)

        # decoder
        self.decoder = setup_module(m_type ='han', in_channels=1024, out_channels=1024, num_layers=1)
